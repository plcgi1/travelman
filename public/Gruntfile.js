...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        cssmin: {
            dist: {
                files: {
                    '<%= yeoman.app %>/styles/main.css': ['.tmp/styles/{,*/}*.css', '<%= yeoman.app %>/styles/{,*/}*.css']
                }
            }
        },
        htmlmin: {
...
/*removeCommentsFromCDATA: true,
            ...
            dist: {
                files: {
                    src: [
                        ...
                        '<%= yeoman.dist %>/images/oauth/{,*/}*.{png,jpg,jpeg,gif,webp,svg}',
    ...
    'cssmin', 'htmlmin', 'concat', 'copy', 'cdnify', 'ngmin', 'uglify', 'rev', 'usemin']);

    grunt.registerTask('default', ['build']);
    grunt.registerTask('buildnomin', ['clean:dist', 'jshint',

    'compass:dist', 'useminPrepare', 'imagemin',

    'cssmin', 'htmlmin', 'concat', 'copy', 'cdnify', 'ngmin', 'rev', 'usemin']);
