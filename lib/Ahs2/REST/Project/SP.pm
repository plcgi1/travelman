package Ahs2::REST::Project::SP;
use strict;
use Ahs2::REST::Project::Backend;
use Ahs2::REST::Project::Map;
...
sub service_object {
    ...
    my $backend = Ahs2::REST::Project::Backend->new(
        {
            model     => $env->{model},
    ...
    my $rest = Ahs2::REST::Engine->new(
        {
            map       => Ahs2::REST::Project::Map->get_map,
            backend   => $backend,
            view      => $view,
            session   => $env->{session},
            model     => $env->{model},
