...
my $map = [
    {
        ...
        in        => {
            ...
            param         => [
                ...
                { name => 'password',      rules => [ {rule => 'latinString'} ], error => "Bad password" },
				{ name => 'login',      rules => [ {rule => 'latinString'} ], error => "Bad login" },
            ]
        },
...
=head1 REST::Ahs2::REST::Auth::Map - [TODO]
