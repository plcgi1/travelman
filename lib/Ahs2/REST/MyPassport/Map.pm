package Ahs2::REST::MyPassport::Map;
use strict;
...
my $map = [
    {
        ...
        in        => {
            ...
            param         => [
				...
				{ name => 'received',    rules => [ {rule => 'anyText' } ], required => 1, error => "Bad received" },
				{ name => 'dob',         rules => [ {rule => 'anyText' } ], required => 1, error => "Bad dob" },
				{ name => 'latin_fname', rules => [ {rule => 'anyText' } ], error => "Bad latin_fname" },
				{ name => 'latin_lname', rules => [ {rule => 'anyText' } ], error => "Bad latin_lname" },
				{ name => 'serial',      rules => [ {rule => 'anyText' } ], error => "Bad serial" },
				{ name => 'number',      rules => [ {rule => 'anyText' } ], error => "Bad number" },
				{ name => 'pob',         rules => [ {rule => 'anyText' } ], error => "Bad pob" },
				{ name => 'org',         rules => [ {rule => 'anyText' } ], error => "Bad org" },
            ]	
        },
...
=head1 REST::Ahs2::REST::MyPassport::Map - [TODO]
