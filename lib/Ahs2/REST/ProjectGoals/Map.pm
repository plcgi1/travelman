package Ahs2::REST::ProjectGoals::Map;
use strict;

my $map = [
    {
        # regexp or absolute value for url to service
        regexp    => '/ahs/projects/project/goals$',
        ...
        in        => {
            ...
            param         => [
				...
				{ name => 'goals',    rules => [ {rule => 'anyText', } ], error => "Bad anyText" },
            ]
        },
    ...
    },
	{
        ...
        in        => {
            ...
            param         => [
                ...
                # all rule names - in WOA::Validator::Rules::Base
				{ name => 'id',         rules => [ {rule => 'integer' } ], error => "Bad id" },
				{ name => 'project_id', rules => [ {rule => 'integer' } ], error => "Bad id" },
				{ name => 'from',       rules => [ {rule => 'datetime', } ], error => "Bad from" },
				{ name => 'to',       	rules => [ {rule => 'datetime', } ], error => "Bad to" },
				{ name => 'name',       rules => [ {rule => 'anyText', } ], error => "Bad name" },
            ]
        },
        # service output description
        out			=>	{
...
=head1 REST::Ahs2::REST::ProjectGoals::Map - [TODO]
