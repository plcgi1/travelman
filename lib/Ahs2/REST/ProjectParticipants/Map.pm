...
my $map = [
    {
        ...
        in        => {
            ...
            param         => [
				...
				{ name => 'participants', rules => [ {rule => 'integer', } ], error => "Bad participants" },
            ]
        },
    ...
    },
	{
        ...
        in        => {
            ...
            param         => [
                ...
                # all rule names - in WOA::Validator::Rules::Base
				{ name => 'id',         rules => [ {rule => 'integer' } ], error => "Bad id" },
				{ name => 'pid',       rules => [ {rule => 'integer', } ], error => "Bad participant-id" },
            ]
        },
        # service output description
        out			=>	{
...
=head1 REST::Ahs2::REST::ProjectParticipants::Map - [TODO]
