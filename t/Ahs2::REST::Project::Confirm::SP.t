...
BEGIN { use_ok 'Ahs2::REST::Project::Confirm::SP' }

Ahs2::REST::Project::Confirm::Tester->process();

package Ahs2::REST::Project::Confirm::Tester;
use strict;
use Ahs2::REST::Project::Confirm::SP;
use Ahs2::REST::Project::Confirm::Map;
...
sub set_up {
    ...
    $sp = Ahs2::REST::Project::Confirm::SP->new;
    $rest = $sp->service_object();
    $map = Ahs2::REST::Project::Confirm::Map::get_map;
