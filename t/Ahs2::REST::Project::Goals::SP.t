...
BEGIN { use_ok 'Ahs2::REST::Project::Goals::SP' }

Ahs2::REST::Project::Goals::Tester->process();

package Ahs2::REST::Project::Goals::Tester;
use strict;
use Ahs2::REST::Project::Goals::SP;
use Ahs2::REST::Project::Goals::Map;
...
sub set_up {
    ...
    $sp = Ahs2::REST::Project::Goals::SP->new;
    $rest = $sp->service_object();
    $map = Ahs2::REST::Project::Goals::Map::get_map;
