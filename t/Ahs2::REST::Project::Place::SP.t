...
BEGIN { use_ok 'Ahs2::REST::Project::Place::SP' }

Ahs2::REST::Project::Place::Tester->process();

package Ahs2::REST::Project::Place::Tester;
use strict;
use Ahs2::REST::Project::Place::SP;
use Ahs2::REST::Project::Place::Map;
...
sub set_up {
    ...
    $sp = Ahs2::REST::Project::Place::SP->new;
    $rest = $sp->service_object();
    $map = Ahs2::REST::Project::Place::Map::get_map;
