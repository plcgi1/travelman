...
BEGIN { use_ok 'Ahs2::REST::Project::Participants::SP' }

Ahs2::REST::Project::Participants::Tester->process();

package Ahs2::REST::Project::Participants::Tester;
use strict;
use Ahs2::REST::Project::Participants::SP;
use Ahs2::REST::Project::Participants::Map;
...
sub set_up {
    ...
    $sp = Ahs2::REST::Project::Participants::SP->new;
    $rest = $sp->service_object();
    $map = Ahs2::REST::Project::Participants::Map::get_map;
