...
BEGIN { use_ok 'Ahs2::REST::Auth::SP' }

Ahs2::REST::Auth::Tester->process();

package Ahs2::REST::Auth::Tester;
use strict;
use Ahs2::REST::Auth::SP;
use Ahs2::REST::Auth::Map;
...
sub set_up {
    ...
    $sp = Ahs2::REST::Auth::SP->new;
    $rest = $sp->service_object();
    $map = Ahs2::REST::Auth::Map::get_map;
